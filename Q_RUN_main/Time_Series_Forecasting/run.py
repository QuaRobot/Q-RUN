# The Code of this part is based on Autoformer (https://github.com/thuml/Autoformer).
import argparse
import torch
...
def main():
    ...
    parser.add_argument('--model', type=str,  default='Modified_Transformer')

    # data loader
    parser.add_argument('--data', type=str, default='ETTh', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./dataset/ETT-small/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='ETTh.csv', help='data file')
    ...
    parser.add_argument('--exp_setting', type=int, default=6, help='experiment setting')
