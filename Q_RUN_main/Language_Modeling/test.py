...
def test(args):
    ...
    print(model)
    model_path = os.path.join('/mnt', "ours_trans_best.pth")
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--log_file", type=str, default="/mnt/test.log")
    parser.add_argument("--log_file", type=str, default="test.log")

    parser.add_argument("--prefix", type=str, default="/mnt/baseline")
