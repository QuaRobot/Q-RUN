...
class tokenized_dataloader:
    def __init__(self, args):
        if args.model == "mamba":
            ...
            self.tokenizer = BertTokenizer.from_pretrained("/mnt/fanmodel/bert")
    ...
    def get_tokenized_dataset(self, dataset_name, part="train"):
        if dataset_name == "sst2":
            ...
            dataset = load_dataset("/mnt/fanmodel/sst2")

            dataset[part] = dataset[part].remove_columns(["idx"])
            dataset[part] = dataset[part].rename_column("sentence", "text")

        elif dataset_name == "imdb":
            dataset = load_dataset("/mnt/fanmodel/imdb")

        elif dataset_name == "sentiment140":
            dataset = load_dataset(r"D:\FAN-main\Sentiment_Analysis\Sentiment140Twitter", encoding='ISO-8859-1')
        elif dataset_name == "amazon_polarity":
            dataset = load_dataset(r"D:\FAN-main\Sentiment_Analysis\amazon_polarity", cache_dir="datasets_cache")
